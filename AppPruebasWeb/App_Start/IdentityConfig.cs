...

{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser, string>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser, ApplicationRole, string, ApplicationUserLogin, ApplicationUserRole, ApplicationUserClaim>(context.Get<rgContexto>()));
    ...
    public class ApplicationDbInitializer : DropCreateDatabaseAlways<rgContexto> 
    {
    ...
    public class ApplicationSignInManager : SignInManager<ApplicationUser, string>
    {
        ...
        {
            return user.GenerateUserIdentityAsync((Rhinog.BaseDeDatos.ApplicationUserManager)UserManager);
        }
